...
{
    m_handlers[std::string(methodString(OPEngineMethod::engine_exchangeCapabilities))] =
        &OPEngineEndpoints::exchangeCapabilities;
    m_handlers[std::string(methodString(OPEngineMethod::engine_forkchoiceUpdatedV1))] =
        &OPEngineEndpoints::forkchoiceUpdatedV1;
    m_handlers[std::string(methodString(OPEngineMethod::engine_forkchoiceUpdatedV2))] =
