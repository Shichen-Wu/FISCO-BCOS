 ...
 *
 * @brief interface for MVBACodec
 * @file MVBACodecInterface.h
 * @author: yujiechen
 * @date 2024-12-15
 */
#pragma once
...
namespace consensus
{
class MVBACodecInterface
{
public:
    using Ptr = std::shared_ptr<MVBACodecInterface>;
    MVBACodecInterface() = default;
    virtual ~MVBACodecInterface() {}

    virtual bytesPointer encode(
        MVBABaseMessageInterface::Ptr _mvbaMessage, int32_t _version = 0) const = 0;
